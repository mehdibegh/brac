...
public class DataBaseServiceBuilder implements HttpClientServiceBuilder {
    ...
    public DataBaseServiceBuilder() {
        System.out.println("Data base service builder created ..!");
        this.httpClientService = new DataBaseHttpClient();
    }
